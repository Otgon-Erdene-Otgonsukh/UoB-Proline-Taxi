    ...
    <div className="flex flex-col min-h-screen items-center pt-15 p-4">
      <div className="grid md:grid-cols-3 grid-cols-1 md:gap-20 gap-0 md:mb-5 mb-2 md:mt-0 -mt-5 md:mx-0 -mx-30">
        ...
        <div className="flex flex-col gap-3 items-center">
          ...
          >
            <div className="bg-linear-to-br from-yellow-400 via-yellow-600 to-yellow-700 rounded-lg px-3 py-3.25 flex justify-center items-center">
        ...
        <div className="flex flex-col gap-3 items-center">
          ...
          >
            <div className="bg-linear-to-br from-red-300 via-red-500 to-red-700 rounded-lg px-3 py-3.25 flex justify-center items-center">
